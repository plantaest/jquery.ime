...
testFixtures.push( {
	...
	tests: [
		...
		{ input: 'xua6n', output: 'xuân', description: 'Vietnamese VNI composes uâ before final n' },
		{ input: 'xua61t', output: 'xuất', description: 'Vietnamese VNI composes uâ before checked final t' },
		{ input: 'xua6t1', output: 'xuất', description: 'Vietnamese VNI composes uâ before tone after checked final t' },
		...
		{ input: 'nguo7i2', output: 'người', description: 'Vietnamese VNI promotes uơ plus i to ươi before tone' },
		{ input: 'nguo72i', output: 'người', description: 'Vietnamese VNI promotes toned uơ plus i to ươi' },
		{ input: 'tu7oi', output: 'tươi', description: 'Vietnamese VNI promotes ưo plus i to ươi' },
		{ input: 'tu7oi1', output: 'tưới', description: 'Vietnamese VNI promotes ưo plus i before tone' },
		...
		{ input: 'd9ieu62', output: 'điều', description: 'Vietnamese VNI iêu rime composition' },
		{ input: 'keu6', output: 'kêu', description: 'Vietnamese VNI eu precursor composes to êu' },
		{ input: 'hue6', output: 'huê', description: 'Vietnamese VNI ue precursor composes to uê' },
		{ input: 'kenh6', output: 'kênh', description: 'Vietnamese VNI enh precursor composes to ênh' },
		{ input: 'nghech61', output: 'nghếch', description: 'Vietnamese VNI ech precursor composes to ếch' },
		{ input: 'huenh6', output: 'huênh', description: 'Vietnamese VNI uenh precursor composes to uênh' },
		{ input: 'huech61', output: 'huếch', description: 'Vietnamese VNI uech precursor composes to uếch' },
...
testFixtures.push( {
	...
	tests: [
		...
		{ input: 'xuaan', output: 'xuân', description: 'Vietnamese Telex composes uâ before final n' },
		{ input: 'xuaats', output: 'xuất', description: 'Vietnamese Telex composes uâ before checked final t' },
		{ input: 'xuaast', output: 'xuất', description: 'Vietnamese Telex reflows uâ when final t follows tone' },
		{ input: 'oawm', output: 'oăm', description: 'Vietnamese Telex composes oă before final m' },
		{ input: 'oawn', output: 'oăn', description: 'Vietnamese Telex composes oă before final n' },
		{ input: 'oawng', output: 'oăng', description: 'Vietnamese Telex composes oă before final ng' },
		{ input: 'oawc', output: 'oăc', description: 'Vietnamese Telex composes oă before checked final c' },
		{ input: 'oawt', output: 'oăt', description: 'Vietnamese Telex composes oă before checked final t' },
		...
		{ input: 'nguowi', output: 'ngươi', description: 'Vietnamese Telex promotes uơ plus i to ươi' },
		{ input: 'nguowif', output: 'người', description: 'Vietnamese Telex promotes uơ plus i before tone' },
		{ input: 'nguowfi', output: 'người', description: 'Vietnamese Telex promotes toned uơ plus i to ươi' },
...
testFixtures.push( {
	...
	tests: [
		...
		{ input: 'xuaan', output: 'xuân', description: 'Vietnamese Simple Telex composes uâ before final n' },
		{ input: 'xuaats', output: 'xuất', description: 'Vietnamese Simple Telex composes uâ before checked final t' },
		{ input: 'oawm', output: 'oăm', description: 'Vietnamese Simple Telex composes oă before final m' },
		{ input: 'oawn', output: 'oăn', description: 'Vietnamese Simple Telex composes oă before final n' },
		...
		{ input: 'tuwoi', output: 'tươi', description: 'Vietnamese Simple Telex promotes ưo plus i to ươi' },
...
testFixtures.push( {
	...
	tests: [
		...
		{ input: 'oa(m', output: 'oăm', description: 'Vietnamese VIQR composes oă before final m' },
		{ input: 'oa(n', output: 'oăn', description: 'Vietnamese VIQR composes oă before final n' },
		{ input: 'ddu+o+`ng', output: 'đường', description: 'Vietnamese VIQR ddu+o+`ng -> đường' },
		{ input: 'nguo+i`', output: 'người', description: 'Vietnamese VIQR promotes uơ plus i before tone' },
		{ input: 'nguo+`i', output: 'người', description: 'Vietnamese VIQR promotes toned uơ plus i to ươi' },
		{ input: 'tu+oi', output: 'tươi', description: 'Vietnamese VIQR promotes ưo plus i to ươi' },
		{ input: 'tu+oi\'', output: 'tưới', description: 'Vietnamese VIQR promotes ưo plus i before tone' },
